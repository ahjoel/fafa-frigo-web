...
const DefaultPalette = (mode: Palette['mode'], skin: Skin): Palette => {
  ...
  const myCustomBgLight = hexToRGBA('#4b8d8e', 0.08)
  ...
  return {
    customColors: {
      ...
      bodyBg: mode === 'light' ? myCustomBgLight : '#25293C', // Same as palette.background.default but doesn't consider bordered skin
