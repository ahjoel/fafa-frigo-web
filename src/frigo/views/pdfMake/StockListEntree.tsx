...
export const generatePdfStockEntree = (data: Mouvement[], fileName: string, dd: string, df: string) => {
  const now = new Date();
  ...
  const tableBody = [
    [
      ...
      { text: 'DATE INSERTION', style: 'tableHeader' },
  ...
  const documentDefinition: any = {
    ...
    header: {
      text: `Situation - Liste des produits entrées au stock du ${dd} au ${df}`,
      alignment: 'center',
      margin: [0, 20, 0, 20],
      fontSize: 15,
      bold: true
    ...
    content: [
      ...
      // Ajout du tableau récapitulatif des totaux par produit
      {
        text: 'Récapitulatif des quantités par produit',
        style: 'subheader',
        alignment: 'center',
        margin: [0, 30, 0, 10]
      },
