...
// import EcommerceInvoiceTable from 'src/views/dashboards/ecommerce/StockList'
...
// import EcommerceCongratulationsJohn from 'src/views/dashboards/ecommerce/WelcomeUser'
