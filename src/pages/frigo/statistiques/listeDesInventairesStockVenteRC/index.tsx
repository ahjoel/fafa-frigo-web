...
const listeDesInventairesStockVenteRC = () => {
  ...
  const getListDatas = async (date_debut: string, date_fin: string) => {
    ...
    try {
      const response = await axios.post(`stat/stock/gene/rc`, dataSearch, {
        headers: {
  ...
  return (
    <Grid container spacing={6.5}>
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Inventaire du stock de vente - RC' sx={{ fontSize: '60px' }} />
...
export default listeDesInventairesStockVenteRC
